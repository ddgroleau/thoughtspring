...
const Disclaimer = () => {
    return (
        <Layout 
            title="Disclaimer & Cookie Policy | ThoughtSpring Creative" 
        ...
        >
            <section style={{
                ...
                <div style={{
                    ...
                    <h1>DISCLAIMER AND COOKIE POLICY</h1>
                    <p><em>Last updated September 12, 2022</em></p>
                    <h2>DISCLAIMER</h2>
                    <h3>WEBSITE DISCLAIMER</h3>
                    <p>
                        The information provided by ThoughtSpring Creative, LLC ("we," "us," or "our") 
                        on https://thoughtspringcreative.com (the "Site") and our mobile application 
                        is for general informational purposes only. All information on the Site and 
                        our mobile application is provided in good faith, however we make no 
                        ...
                        SHALL WE HAVE ANY LIABILITY TO YOU FOR ANY LOSS OR DAMAGE OF ANY KIND INCURRED 
                        ...
                        ANY INFORMATION ON THE SITE AND OUR MOBILE APPLICATION IS SOLELY AT YOUR OWN RISK.
                    </p>
                    <br/>
                    <h2>COOKIE POLICY</h2>
                    <p>
                        This Cookie Policy explains how ThoughtSpring Creative, 
                        LLC (&quot;Company&quot;, &quot;we&quot;, &quot;us&quot;, and &quot;our&quot;) uses 
                        cookies and similar technologies to recognize you when you visit our websites at
                        <Link href="https://thoughtspringcreative.com/">
                            &nbsp;https://thoughtspringcreative.com</Link>, (&quot;Websites&quot;). 
                    ...
                    <p>
                        Cookies set by the website owner (in this case,ThoughtSpring Creative, LLC) 
                    ...
                    <p>
                        ...
                        necessary&quot; cookies. Other cookies also enable us to track and target the interests 
                        of our users to enhance the experience on our Online Properties. Third parties serve 
                    ...
                    <p>
                        You may set or amend your web browser 
                    ...
                    <p>
                        ...
                        out of targeted advertising. If you would like to find out more information, 
                        please visit&nbsp;
                        <Link href="http://www.aboutads.info/choices/">http://www.aboutads.info/choices/</Link> 
                        or&nbsp;<Link href="http://www.youronlinechoices.com/">http://www.youronlinechoices.com</Link>.
                    </p>
                    <h3>What about other tracking technologies, like web beacons?</h3>
                    <p>
                        Cookies are not the only way to recognize or track visitors 
                        to a website. We may use other, similar technologies from time to time, 
                        like web beacons (sometimes called &quot;tracking pixels&quot; or &quot;clear gifs&quot;). 
                        These are tiny graphics files that contain a unique identifier that enable 
                        ...
                        the success of e-mail marketing campaigns. In many instances, these technologies 
                    ...
                    <p>
                        ...
                        and store information about your use of our services, fraud prevention 
                    ...
                    <p>
                        ...
                        or limit acceptance of Flash Cookies may reduce or impede 
                    ...
                    <p>
                        ...
                        that is used to measure the effectiveness of advertisements. This can be accomplished by 
                        them using cookies or web beacons to collect information about your visits to this and 
                        other sites in order to provide relevant advertisements about goods and services of 
                    ...
                    <p>
                        ...
                        please email us at info@thoughtspringcreative.com.
                    </p>
                </div>
            </section>
        </Layout>
